...
# Set title
if os.name == 'nt':
    os.system(f"title Lolz.guru View Bot • Starting...")

# Set logging system
logging.basicConfig(handlers=[logging.FileHandler('lolz_viewbot.log', 'w+', 'utf-8')], level=logging.ERROR, format='%(asctime)s: %(message)s')
